...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'您的服务器使用的 PHP 版本是 %s，但是 WordPress 要求至少 4.3。'/*/WP_I18N_OLD_PHP*/, php_version() ) );
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( '您安装的 PHP 似乎缺少 MySQL 数据库扩展，此扩展是对 WordPress 必需的。' );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>错误</strong>: <code>wp-config.php</code> 中的数据表前缀 <code>$table_prefix</code> 只能使用数字，字母和下划线。'/*/WP_I18N_BAD_PREFIX*/);
